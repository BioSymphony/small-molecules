...
- **License:** **Apache-2.0** code. ⚠️ **Weights not released** ("TODO: coming soon"; `ollama pull ChemDual` is aspirational). Only small eval JSONs in `dataset/`; the 4.4M instruction set is unreleased. Base LLaMA-3.1-8B carries Meta's restrictive Community License.
